...
export default function Create() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Form Field" />
            <div className="p-4">
                <div className="mb-4 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <Settings className="h-5 w-5 text-blue-600" />
                        <h1 className="text-xl font-semibold">Tambah Form Field Baru</h1>
                    </div>
                    <Button 
                        variant="outline" 
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Konfigurasi field yang akan ditampilkan pada formulir pendaftaran
                            </CardDescription>
                        </CardHeader>
                    ...
                    {needsOptions && (
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Konfigurasi pilihan untuk field select atau radio button
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="space-y-2">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Konfigurasi tambahan untuk field
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
